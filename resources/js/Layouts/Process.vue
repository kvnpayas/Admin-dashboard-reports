...
<template>
  <div class="flex space-x-4 justify-center">
    <div>
      <div
        :class="{ 'flex flex-col justify-center min-w-80 mt-10 space-x-5 p-10 shadow-2xl rounded-md process-div overflow-hidden': true, 'min-h-56 max-h-56': startProcess, 'max-h-28 min-h-28': !startProcess }">
        <div class="text-center flex flex-col" v-if="!startProcess">
